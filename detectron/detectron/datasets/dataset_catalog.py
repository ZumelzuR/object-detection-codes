...
_DATASETS = {
    ...
    'coco_2017_test': {
        _IM_DIR:
            _DATA_DIR + '/coco/test',
        _ANN_FN:
            _DATA_DIR + '/coco/annotations/test_instances.json'
    },
    'coco_2017_train': {
        _IM_DIR:
            _DATA_DIR + '/coco/train',
        _ANN_FN:
            _DATA_DIR + '/coco/annotations/train_instances.json'
    },
    'coco_2017_val': {
        _IM_DIR:
            _DATA_DIR + '/coco/val',
        _ANN_FN:
            _DATA_DIR + '/coco/annotations/val_instances.json'
    },
    'coco_2014_train_': {
        _IM_DIR:
    ...
    'coco_2017_test_': {  # 2017 test uses 2015 test images
        _IM_DIR:
            _DATA_DIR + '/coco/coco_test2015',
        _ANN_FN:
